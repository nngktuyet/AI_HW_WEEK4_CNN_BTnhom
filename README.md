...
## 19. Ảnh được lưu sau khi chụp Palmistry

Sau khi nhấn SPACE, chương trình tự tạo folder:
...
* `palm_roi.jpg`: vùng lòng bàn tay được crop từ webcam.
* `life.jpg`: vùng sinh đạo.
* `heart.jpg`: vùng tâm đạo.
* `head.jpg`: vùng trí đạo.
* `fate.jpg`: vùng định mệnh đạo.

Có thể mở các ảnh này để kiểm tra vùng crop có đúng không.
